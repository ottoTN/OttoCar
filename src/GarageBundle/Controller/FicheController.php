...
class FicheController extends Controller
{
     ...
     public function indexreceptionnistAction()
    {
        ...
        return $this->render('fiche/index-receptionnist.html.twig', array(
            'fiches' => $fiches,
            'pieces' => $pieces,
        ));
    }
    ...
    public function indexaccountantAction()
    {
        ...
        return $this->render('fiche/index-accountant.html.twig', array(
            'fiches' => $fiches,
        ));
    }
    ...
    public function indexmanagerAction()
    {
        ...
        $fiches = $em->getRepository('GarageBundle:Fiche')->findAll();
        $pieces = $em->getRepository('GarageBundle:Piece')->findAll();
        return $this->render('fiche/index-manager.html.twig', array(
            'fiches' => $fiches,
            'pieces' => $pieces,
        ));
    }
